                ...
                <article class="address-card">
                    ...
                    <div class="address-card-actions">
                        <button type="button" class="boton-pastel card-warning address-edit-btn"
                            title="Editar dirección" aria-label="Editar dirección" data-address-modal-open="edit"
                            data-address-id="{{ $address->id }}" data-address-type="{{ $address->type }}"
                        ...
                        <form method="POST" action="{{ route('site.profile.addresses.destroy', $address) }}"
                            class="address-delete-form">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="boton-pastel card-danger address-delete-btn"
