    ...
    <div class="overview-grid">
        ...
        <article class="overview-card">
            ...
            <div class="overview-card-body">
                ...
                @if (isset($orders) && $orders->isNotEmpty())
                    ...
                    <a href="{{ route('site.profile.index', ['section' => 'orders']) }}" class="overview-link">Ver
        ...
        <article class="overview-card">
            ...
            <div class="overview-card-body">
                ...
                @if (isset($wishlistItems) && $wishlistItems->isNotEmpty())
                    ...
                    <a href="{{ route('site.profile.index', ['section' => 'wishlist']) }}" class="overview-link">Ver
                        todos los favoritos</a>
                @else
            ...
            <div class="overview-card-body">
                ...
                @if (isset($addresses) && $addresses->isNotEmpty())
                    ...
                    <a href="{{ route('site.profile.index', ['section' => 'addresses']) }}"
                        class="overview-link">Gestionar direcciones</a>
                @else
        ...
        <article class="overview-card">
            ...
            <div class="overview-card-body">
                ...
                <a href="{{ route('site.profile.index', ['section' => 'security']) }}#password-section"
                    class="overview-link">
