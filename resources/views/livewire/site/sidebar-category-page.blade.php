@if ($category->children->isNotEmpty())
    <section class="site-sidebar-page" data-sidebar-page="category-{{ $category->id }}" aria-hidden="true">
        ...
        <div class="site-sidebar-page-nav">
            ...
            <a href="{{ route('categories.show', $category) }}" class="site-btn site-btn-primary site-sidebar-cta"
                data-sidebar-close>
