...
<form method="POST" action="{{ route('admin.company-settings.update-identity') }}" enctype="multipart/form-data"
    ...
    @endif
    <section id="companySettingsSectionIdentity" data-section="identity" role="tabpanel" aria-labelledby="tab-identity"
                    ...
                    <div class="form-row-fit">
                            ...
                            <div class="color-input-wrapper" data-color-picker data-default-color="{{ $primaryColor }}">
                                ...
                                <div class="input-icon-container">
                                    ...
                                    <input type="text" name="primary_color" id="primary_color"
                                        class="input-form color-text-input" value="{{ $primaryColor }}"
                        ...
                        <div class="input-group">
                            ...
                            <div class="color-input-wrapper" data-color-picker
                                data-default-color="{{ $secondaryColor }}">
                                <span class="color-preview" data-color-preview
                                ...
                                <div class="input-icon-container">
                                    ...
                                    <input type="text" name="secondary_color" id="secondary_color"
                                        class="input-form color-text-input" value="{{ $secondaryColor }}"
                                        placeholder="#0EA5E9" data-validate="pattern:^#(?:[0-9a-fA-F]{3}){1,2}$"
                                        data-color-input="text" autocomplete="off">
                                </div>
                                <button type="button" class="color-copy-btn" data-color-copy data-copy-label="Copiar"
                                    data-copied-label="Copiado" title="Copiar valor de color">
