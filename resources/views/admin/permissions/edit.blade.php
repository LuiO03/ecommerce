        ...
        <div class="card-body">
            <form action="{{ route('admin.permissions.update', $permission) }}" method="POST" autocomplete="off">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="description" id="description" class="form-input" value="{{ old('description', $permission->description) }}" maxlength="255" placeholder="Breve descripción del permiso">
                    @error('description')
                        <x-alert type="danger" :items="[$message]" />
                    @enderror
                </div>
