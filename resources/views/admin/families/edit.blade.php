@section('title', 'Editar familia: ' . $family->name)
...
<x-admin-layout>
    ...
    <x-slot name="action">
        <a href="{{ route('admin.families.index') }}" class="boton-form boton-accent">
                ...
                <div class="input-group">
                    ...
                    <div class="binary-switch">
                        ...
                        <input type="checkbox" name="status" id="status" class="switch-input" value="1"
                            {{ old('status', $family->status) == 1 ? 'checked' : '' }} data-validate="required">
