...
<form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="form-container"
            ...
            <div class="image-upload-section">
                ...
                <div class="image-filename" id="imageFilename"
                    ...
                    <span id="filenameText">
                        {{ $user->image ? basename($user->image) : '' }}
                    </span>
                </div>
            </div>
    ...
    <div class="form-footer">
        ...
        <button class="boton-form boton-accent" type="submit" id="submitBtn">
            ...
            <span class="boton-form-text">Actualizar Perfil</span>
        </button>
    </div>
</form>
