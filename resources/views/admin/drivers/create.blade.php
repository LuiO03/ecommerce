...
<x-admin-layout>
    ...
    <form action="{{ route('admin.drivers.store') }}" method="POST" class="form-container" autocomplete="off"
        id="driverForm">
        @csrf
                ...
                <div class="input-group">
                    ...
                    <div class="input-icon-container">
                        ...
                        <input type="text" name="vehicle_plate" id="vehicle_plate" class="input-form"
                            value="{{ old('vehicle_plate') }}" placeholder="ABC-123" data-validate="max:20">
                    </div>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-icon-container">
                        ...
                        <input type="text" name="phone" id="phone" class="input-form"
                            value="{{ old('phone') }}" placeholder="Teléfono del conductor" data-validate="max:20">
                    </div>
                </div>
