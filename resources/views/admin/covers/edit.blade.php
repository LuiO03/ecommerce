                ...
                <div class="input-group">
                    ...
                    <div class="binary-switch">
                        ...
                        <input type="checkbox" name="status" id="status" class="switch-input" value="1"
                            {{ old('status', $cover->status) == 1 ? 'checked' : '' }} data-validate="required">
                ...
                <div class="input-group">
                    ...
                    <div class="input-icon-container">
                        ...
                        <input type="text" name="overlay_subtext" id="overlay_subtext" class="input-form"
                            ...
                            value="{{ old('overlay_subtext', $cover->overlay_subtext) }}" data-validate="max:250|requiredWith:overlay_text">
                    </div>
                </div>
                <div class="form-row-fit">
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="binary-switch">
                            ...
                            <input type="checkbox" name="overlay_bg_enabled" id="overlayBg" class="switch-input"
                                value="1" {{ old('overlay_bg_enabled', $cover->overlay_bg_enabled) == 1 ? 'checked' : '' }}
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="text_position" id="text_position"
                            value="{{ old('text_position', $cover->text_position ?? 'center-center') }}" data-validate="requiredWith:overlay_text">
