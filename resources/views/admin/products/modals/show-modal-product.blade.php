				...
				<div class="modal-img-container">
					<div id="product-image-slider" class="modal-img-slider hidden" aria-live="polite">
						<div class="slider-main">
							<button type="button" class="slider-btn prev-btn hidden" id="product-slider-prev" aria-label="Imagen anterior">
								<i class="ri-arrow-left-s-line"></i>
							</button>
							<div class="slider-track" id="product-slider-track"></div>
							<button type="button" class="slider-btn next-btn hidden" id="product-slider-next" aria-label="Imagen siguiente">
...
@push('scripts')
	<script>
		...
		function closeProductModal() {
			destroyProductSlider({ restorePlaceholder: false });
		...
		function destroyProductSlider({ restorePlaceholder = true } = {}) {
		...
		function renderProductGallery(images) {
			...
			if (!images.length) {
				$gallery.html('<p class="label-hint"><i class="ri-information-line"></i> No se registraron imágenes para este producto.</p>');
				return;
			}
		...
		function renderProductModal(data) {
			...
			loadValidImages(rawImages)
				...
				.catch(() => {
					...
					$('#product-image-placeholder').removeClass('hidden').html('<i class="ri-error-warning-line"></i> Error al cargar la galería');
					$('#product-gallery').html('<p class="label-hint"><i class="ri-error-warning-line"></i> No se pudieron renderizar las imágenes.</p>');
				});
		...
		function loadProductModal(slug) {
			...
			$.ajax({
				...
				error: function() {
					...
					$('#product-image-placeholder').removeClass('hidden').html('<i class="ri-error-warning-line"></i> Error al cargar la galería');
					$('#product-gallery').html('<p class="label-hint"><i class="ri-error-warning-line"></i> Ocurrió un problema al cargar las imágenes.</p>');
				}
			});
		}
